...
{
    public class OgunYemekManager : Manager<OgunYemekViewModel, OgunYemek, OgunYemekMappingProfile>
    {
        public OgunYemekManager()
        {
            _repository = new OgunYemekRepository(new DiyetProgramiDbContext());
