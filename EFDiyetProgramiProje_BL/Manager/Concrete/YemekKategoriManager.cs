...
{
    public class YemekKategoriManager : Manager<YemekKategoriViewModel, YemekKategori, YemekKategoriMappingProfile>
    {
        public YemekKategoriManager()
        {
            _repository = new YemekKategoriRepository(new DiyetProgramiDbContext());
