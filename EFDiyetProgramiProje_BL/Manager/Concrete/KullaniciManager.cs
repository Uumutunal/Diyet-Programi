...
{
    public class KullaniciManager : Manager<KullaniciViewModel, Kullanici, KullaniciMappingProfile>
    {
        public KullaniciManager()
        {
            _repository = new KullaniciRepository(new DiyetProgramiDbContext());
        }
    }
}
