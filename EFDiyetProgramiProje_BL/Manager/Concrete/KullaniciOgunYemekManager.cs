...
{
    public class KullaniciOgunYemekManager : Manager<KullaniciOgunYemekViewModel, KullaniciOgunYemek, KullaniciOgunYemekMappingProfile>
    {
        public KullaniciOgunYemekManager()
        {
            _repository = new KullaniciOgunYemekRepository(new DiyetProgramiDbContext());
