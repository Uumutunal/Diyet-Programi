        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sifre2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Sifre3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Sifre4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KullaniciBilgiId = table.Column<int>(type: "int", nullable: true),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DataStatus = table.Column<int>(type: "int", nullable: false)
